    ...
    public static class EnvironmentInfo
    {
        ...
        public static void LogSummary()
        {
            try
            {
                ...
                sb.AppendLine("[startup] environment summary:");
        ...
        /// <summary>
        /// The display scaling as text ("100%", "125%", ...), or null if it can't
        /// be read. This is what differs between a typical PC monitor (100%) and a
        /// laptop (125%/150%), so it's shown in About and bug-report diagnostics.
        /// </summary>
        public static string GetDisplayScaleText()
        {
            try
            {
                using (var g = System.Drawing.Graphics.FromHwnd(IntPtr.Zero))
                {
                    return (g.DpiX / 96f).ToString("0%");
                }
            }
            catch
            {
